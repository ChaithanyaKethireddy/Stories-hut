...
import { ArrowLeft, Users, PenTool, Image as ImageIcon, Plus, MessageCircle, Heart, ChevronRight } from "lucide-react";
                        ...
                        <div className="bg-white rounded-2xl border border-plum/[0.1] p-6">
                            ...
                            <ul className="space-y-4 list-none m-0 p-0">
                                {[
                                    ...
                                    { icon: <ImageIcon size={16} />, text: "Professional headshots only." },
