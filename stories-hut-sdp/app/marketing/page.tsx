...
import { ChevronDown, Plus, Megaphone, Target, UserCircle, Rocket, Award, Star, ArrowRight, PenSquare, Sparkles, ChevronRight } from "lucide-react";
...
const GROWTH_TOOLS = [
    { label: "Pre-Launch Campaigns" },
    { label: "Gifting Tools" },
    { label: "Instant Preview Sharing" },
];
