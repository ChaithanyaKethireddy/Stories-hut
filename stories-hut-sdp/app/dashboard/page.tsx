...
import { Search, ChevronDown, Filter, CheckCircle2, Circle, MoreVertical, PlayCircle, Eye, PenBox, LibrarySquare, PenTool } from "lucide-react";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.6fr_1fr_1fr_1fr] gap-8 md:gap-12 mb-12">
                    <div className="col-span-1 md:col-span-2 lg:col-span-1">
                        <Link href="/" className="flex items-center gap-2.5 font-playfair text-[1.05rem] font-bold text-white/90 no-underline mb-3.5">
                            <img src="/logo.png" alt="Story Hut" className="w-[30px] h-[30px] rounded-lg bg-white object-contain" />
                            Story Hut
                        </Link>
